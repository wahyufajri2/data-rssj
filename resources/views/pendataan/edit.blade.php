...
@section('content')
<!-- Edit Data Pendataan Keluarga (Ranting Siaga Sehat Jiwa) -->
<div class="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-5xl mx-auto" x-data="{ 
        indikator_gj: {{ json_encode(old('indikator_gj', $pendataan->indikator_gj ?? [])) }}, 
        indikator_rmp: {{ json_encode(old('indikator_rmp', $pendataan->indikator_rmp ?? [])) }},
        lainnya_text: '',
        ...
        <div class="relative rounded-2xl overflow-hidden mb-8 shadow-lg">
            ...
            <div class="relative p-8 sm:p-10 text-white flex flex-col sm:flex-row items-center justify-between">
                <div>
                    <h2 class="text-3xl font-extrabold tracking-tight mb-2">Edit Data Pendataan Keluarga</h2>
                ...
                <div class="p-6">
                        ...
                        <label class="block text-sm font-semibold text-indigo-900 dark:text-indigo-300 mb-2">Pilih Ranting Tujuan (Khusus Superadmin) <span class="text-red-500">*</span></label>
                            <select id="ranting-select" name="ranting_id" required class="block w-full rounded-lg border-indigo-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 bg-white dark:bg-gray-700 dark:border-gray-600 dark:text-white py-3 px-4">
                                ...
                                @foreach($rantings as $ranting)
                                    <option value="{{ $ranting->id }}" {{ old('ranting_id', $pendataan->ranting_id) == $ranting->id ? 'selected' : '' }}>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-1">
                            ...
                            <input type="text" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9]/g, '')" name="no_kk" placeholder="Masukkan Nomor Kartu Keluarga" required  value="{{ old('no_kk', $pendataan->no_kk) }}" class="block w-full rounded-lg border-gray-300 bg-gray-50 dark:bg-gray-700 dark:border-gray-600 focus:bg-white dark:focus:bg-gray-800 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors py-2.5 px-4 dark:text-white">
                        </div>
                        <div class="space-y-1">
                            ...
                            <input type="text" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9]/g, '')" name="nik" placeholder="Masukkan Nomor Induk Kependudukan" required  value="{{ old('nik', $pendataan->nik) }}" class="block w-full rounded-lg border-gray-300 bg-gray-50 dark:bg-gray-700 dark:border-gray-600 focus:bg-white dark:focus:bg-gray-800 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors py-2.5 px-4 dark:text-white">
                        </div>
                        <div class="space-y-1">
                            ...
                            <select name="status_keluarga" required class="block w-full rounded-lg border-gray-300 bg-gray-50 dark:bg-gray-700 dark:border-gray-600 focus:bg-white dark:focus:bg-gray-800 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors py-2.5 px-4 dark:text-white appearance-none">
                                ...
                                <option value="Ayah" {{ old('status_keluarga', $pendataan->status_keluarga) == 'Ayah' ? 'selected' : '' }}>Ayah</option>
                                <option value="Ibu" {{ old('status_keluarga', $pendataan->status_keluarga) == 'Ibu' ? 'selected' : '' }}>Ibu</option>
                                <option value="Anak" {{ old('status_keluarga', $pendataan->status_keluarga) == 'Anak' ? 'selected' : '' }}>Anak</option>
                                <option value="Lainnya" {{ old('status_keluarga', $pendataan->status_keluarga) == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                            </select>
                        </div>
                        <div class="space-y-1">
                            ...
                            <input type="text" name="nama_lengkap" placeholder="Masukkan nama lengkap" required  value="{{ old('nama_lengkap', $pendataan->nama_lengkap) }}" class="block w-full rounded-lg border-gray-300 bg-gray-50 dark:bg-gray-700 dark:border-gray-600 focus:bg-white dark:focus:bg-gray-800 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors py-2.5 px-4 dark:text-white">
                        </div>
                        <div class="space-y-1">
                            ...
                            <div class="relative">
                                <input type="number" name="umur" placeholder="0" required  value="{{ old('umur', $pendataan->umur) }}" class="block w-full rounded-lg border-gray-300 bg-gray-50 dark:bg-gray-700 dark:border-gray-600 focus:bg-white dark:focus:bg-gray-800 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors py-2.5 px-4 dark:text-white">
                        ...
                        <div class="space-y-1">
                            ...
                            <select name="status_kawin" required class="block w-full rounded-lg border-gray-300 bg-gray-50 dark:bg-gray-700 dark:border-gray-600 focus:bg-white dark:focus:bg-gray-800 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors py-2.5 px-4 dark:text-white appearance-none">
                                <option value="">Pilih Status</option>
                                <option value="Belum Kawin" {{ old('status_kawin', $pendataan->status_kawin) == 'Belum Kawin' ? 'selected' : '' }}>Belum Kawin</option>
                                <option value="Kawin" {{ old('status_kawin', $pendataan->status_kawin) == 'Kawin' ? 'selected' : '' }}>Kawin</option>
                                <option value="Cerai Hidup" {{ old('status_kawin', $pendataan->status_kawin) == 'Cerai Hidup' ? 'selected' : '' }}>Cerai Hidup</option>
                                <option value="Cerai Mati" {{ old('status_kawin', $pendataan->status_kawin) == 'Cerai Mati' ? 'selected' : '' }}>Cerai Mati</option>
                            </select>
                        </div>
                        <div class="space-y-1">
                            ...
                            <select name="pendidikan" required class="block w-full rounded-lg border-gray-300 bg-gray-50 dark:bg-gray-700 dark:border-gray-600 focus:bg-white dark:focus:bg-gray-800 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors py-2.5 px-4 dark:text-white appearance-none">
                                ...
                                <option value="Tidak Sekolah" {{ old('pendidikan', $pendataan->pendidikan) == 'Tidak Sekolah' ? 'selected' : '' }}>Tidak Sekolah / Belum Tamat SD</option>
                                <option value="SD" {{ old('pendidikan', $pendataan->pendidikan) == 'SD' ? 'selected' : '' }}>SD Sederajat</option>
                                <option value="SMP" {{ old('pendidikan', $pendataan->pendidikan) == 'SMP' ? 'selected' : '' }}>SMP Sederajat</option>
                                <option value="SMA" {{ old('pendidikan', $pendataan->pendidikan) == 'SMA' ? 'selected' : '' }}>SMA Sederajat</option>
                                <option value="Diploma" {{ old('pendidikan', $pendataan->pendidikan) == 'Diploma' ? 'selected' : '' }}>Diploma (D1-D4)</option>
                                <option value="S1" {{ old('pendidikan', $pendataan->pendidikan) == 'S1' ? 'selected' : '' }}>Sarjana (S1)</option>
                                <option value="S2" {{ old('pendidikan', $pendataan->pendidikan) == 'S2' ? 'selected' : '' }}>Magister (S2)</option>
                                <option value="S3" {{ old('pendidikan', $pendataan->pendidikan) == 'S3' ? 'selected' : '' }}>Doktor (S3)</option>
                            </select>
                        </div>
                        <div class="space-y-1">
                            ...
                            <input type="text" name="pekerjaan" placeholder="Contoh: Petani, Wiraswasta" required value="{{ old('pekerjaan', $pendataan->pekerjaan) }}" class="block w-full rounded-lg border-gray-300 bg-gray-50 dark:bg-gray-700 dark:border-gray-600 focus:bg-white dark:focus:bg-gray-800 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors py-2.5 px-4 dark:text-white">
                        </div>
                        <div class="space-y-1">
                            ...
                            <input type="text" name="alamat_dusun" placeholder="Nama Dusun / Jalan" required  value="{{ old('alamat_dusun', $pendataan->alamat_dusun) }}" class="block w-full rounded-lg border-gray-300 bg-gray-50 dark:bg-gray-700 dark:border-gray-600 focus:bg-white dark:focus:bg-gray-800 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors py-2.5 px-4 dark:text-white">
                        </div>
                        <div class="space-y-1 md:col-span-2">
                            <label class="text-sm font-medium text-gray-700 dark:text-gray-300">Nomor Rumah / RT RW</label>
                            <input type="text" name="no_rumah" placeholder="Opsional"  value="{{ old('no_rumah', $pendataan->no_rumah) }}" class="block w-full rounded-lg border-gray-300 bg-gray-50 dark:bg-gray-700 dark:border-gray-600 focus:bg-white dark:focus:bg-gray-800 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors py-2.5 px-4 dark:text-white">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
                        ...
                        <label class="relative flex items-start p-4 rounded-xl cursor-pointer border-2 transition-all duration-200 ease-in-out hover:bg-red-50 dark:hover:bg-red-900/20"
                            ...
                            <div class="flex items-center h-5">
                                <input type="checkbox" name="indikator_gj[]" value="{{ $option }}" x-model="indikator_gj" x-model="indikator_gj" class="w-5 h-5 text-red-600 border-gray-300 rounded focus:ring-red-500 dark:bg-gray-700 dark:border-gray-600 dark:ring-offset-gray-800">
                            </div>
                            ...
                            @if($option === 'Lainnya(tulis sendiri)')
                                <label class="relative flex flex-col items-start p-4 rounded-xl cursor-pointer border-2 transition-all duration-200 ease-in-out hover:bg-orange-50 dark:hover:bg-orange-900/20"
                                    ...
                                    <div class="flex items-center w-full">
                                        <div class="flex items-center h-5">
                                            <input type="checkbox" name="indikator_rmp[]" value="{{ $option }}" x-model="indikator_rmp" x-model="indikator_rmp" class="w-5 h-5 text-orange-600 border-gray-300 rounded focus:ring-orange-500 dark:bg-gray-700 dark:border-gray-600 dark:ring-offset-gray-800">
                                        </div>
                                        <div class="ml-3 flex-1">
