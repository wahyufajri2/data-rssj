        ...
        <form action="{{ route('kuesioner.update', $kuesioner->id) }}" method="POST">
            ...
            <div class="fixed bottom-0 left-0 w-full xl:w-[calc(100%-290px)] xl:ml-[290px] bg-white/90 dark:bg-gray-900/90 backdrop-blur-md border-t border-gray-200 dark:border-gray-800 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] transition-all z-20">
                <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
                    ...
                    <button type="button" x-show="step === 2" @click="step = 1" class="flex items-center gap-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 px-6 py-2.5 px-4 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 font-medium transition-colors">
                    ...
                    <div x-show="step === 1" class="w-full flex justify-end">
                        ...
                        " class="flex items-center gap-2 bg-blue-600 text-white px-8 py-2.5 px-4 rounded-xl hover:bg-blue-700 font-medium transition-colors shadow-lg hover:shadow-blue-500/30">
                            Selanjutnya
                    ...
                    <div x-show="step === 2" class="flex justify-end" style="display: none;">
                        <button type="submit" class="flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white px-8 py-2.5 px-4 rounded-xl font-bold transition-all shadow-lg hover:shadow-emerald-500/30 hover:-translate-y-0.5">
