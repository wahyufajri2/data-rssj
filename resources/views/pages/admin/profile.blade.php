...
@section('content')
    <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] lg:p-6">
            ...
            {{-- MENGHAPUS :infoLabel="$infoLabel" DAN MENGGANTINYA DENGAN DATA LANGSUNG --}}
            {{-- Karena ini Admin, kita asumsikan informasi tambahannya adalah Email --}}
            <x-profile.personal-info-card infoLabel="Email" :infoValue="$user->email ?? '-'" />
