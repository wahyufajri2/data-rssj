        ...
        <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
            <div class="flex w-full flex-1 flex-col lg:w-1/2">
                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div>
                        <div class="mb-10 sm:mb-18">
                            <h1 class="text-title-sm sm:text-title-md mb-2 font-semibold text-gray-800 dark:text-white/90">
                                Selamat Datang 👋
                            </h1>
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Silakan masuk untuk mengakses sistem prestasi.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            @error('username')
                                <div class="mb-4">
                                    <x-ui.alert variant="error" title="Error" message="{{ $message }}"
                                        :showLink="false" />
                                </div>
                            @enderror
                                ...
                                <div class="space-y-5">
                                    <div>
                                        ...
                                        <input type="text" id="username" name="username" value="{{ old('username') }}"
                                            ...
                                            class="@error('username') border-red-500 focus:border-red-500 focus:ring-red-500/10 @enderror dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div x-data="{ showPassword: false }" class="relative">
                                            <input :type="showPassword ? 'text' : 'password'" name="password"
                                                ...
                                                class="@error('password') border-red-500 focus:border-red-500 focus:ring-red-500/10 @enderror dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pr-11 pl-4 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                            ...
                            {{-- <div class="mt-5">
                                <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                    Belum punya akun?
                                    <a href="#"
                                        class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Daftar
                                        (Opsional)</a>
                                </p>
                            </div> --}}
                        </div>
            ...
            <div
                class="bg-brand-950 relative hidden h-full w-full items-center justify-center lg:flex lg:w-1/2 dark:bg-white/5">
                ...
                <div class="z-10 flex flex-col items-center justify-center px-10 text-center">
                    <a href="https://kemahasiswaan.unisayogya.ac.id/" target="_blank"
                        ...
                        <img src="{{ asset('images/logo/logo-dark.svg') }}" alt="Logo BKA" class="h-30 w-auto" />
                    </a>

                    <div class="mb-6 rounded-full bg-white/10 p-6 backdrop-blur-sm ring-1 ring-white/20">
                        <svg class="h-24 w-24 text-yellow-400 drop-shadow-lg" fill="currentColor" viewBox="0 0 24 24">
                            <path
                                d="M5 2C3.346 2 2 3.346 2 5C2 6.654 3.346 8 5 8V9C5 12.382 7.377 15.223 10.5 15.895V19H7V21H17V19H13.5V15.895C16.623 15.223 19 12.382 19 9V8C20.654 8 22 6.654 22 5C22 3.346 20.654 2 19 2H5ZM5 4H6V6H5C4.448 6 4 5.552 4 5C4 4.448 4.448 4 5 4ZM18 6H19C19.552 6 20 5.552 20 5C20 4.448 19.552 4 19 4H18V6Z" />
                            <path d="M8 4H16V10C16 12.206 14.206 14 12 14C9.794 14 8 12.206 8 10V4Z" class="opacity-80" />
                        </svg>
                    </div>

                    <h2 class="mb-3 text-3xl font-bold text-white tracking-wide">
                        SIM PRESTASI MAHASISWA
                    </h2>
                    <p class="max-w-md text-base text-gray-300 dark:text-white/70">
                        Sistem Informasi Manajemen untuk Mencatat dan Mengapresiasi <br />
                        <span class="text-white font-medium">Pencapaian Non-Akademik.</span>
                    </p>
                </div>
            </div>
