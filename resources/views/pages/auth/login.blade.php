...
@section('content')
    <div class="relative z-1 bg-white p-6 sm:p-0 dark:bg-gray-900 transition-colors duration-300">
        <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">

            <div class="flex w-full flex-1 flex-col lg:w-1/2">
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div>
                        <div class="mb-10 sm:mb-18 text-center sm:text-left">
                            <h1 class="text-title-sm sm:text-title-md mb-2 font-bold text-gray-800 dark:text-white/90">
                                Selamat Datang di EMBRACE
                            </h1>
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Silakan masuk menggunakan Nomor HP Anda untuk melanjutkan sesi.
                            </p>
                        </div>
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="tel" id="no_hp" name="no_hp" value="{{ old('no_hp') }}"
                                            ...
                                            class="@error('no_hp') border-red-500 focus:border-red-500 focus:ring-red-500/10 @enderror dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 transition-colors" />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div x-data="{ showPassword: false }" class="relative">
                                            <input :type="showPassword ? 'text' : 'password'" name="password"
                                                ...
                                                class="@error('password') border-red-500 focus:border-red-500 focus:ring-red-500/10 @enderror dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pr-11 pl-4 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 transition-colors" />
                                            <span @click="showPassword = !showPassword"
                                                class="absolute top-1/2 right-4 z-30 -translate-y-1/2 cursor-pointer text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition-colors">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <a href="{{ route('password.request') }}"
                                            class="text-brand-500 hover:text-brand-600 dark:text-brand-400 dark:hover:text-brand-300 text-sm transition-colors">
                                            Lupa Password?
                                        </a>
                                    </div>
